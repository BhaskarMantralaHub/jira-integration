...
public class AvatarUrls__1 {
    ...
    public String toString() {
        ...
        sb.append(AvatarUrls__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("_48x48");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AvatarUrls__1) == false) {
            return false;
        }
        AvatarUrls__1 rhs = ((AvatarUrls__1) other);
