...
public class AvatarUrls__3 {
    ...
    public String toString() {
        ...
        sb.append(AvatarUrls__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("_48x48");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AvatarUrls__3) == false) {
            return false;
        }
        AvatarUrls__3 rhs = ((AvatarUrls__3) other);
